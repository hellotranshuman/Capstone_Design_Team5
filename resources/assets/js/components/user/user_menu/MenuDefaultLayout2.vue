...
@media (max-width: 639px){   
    .menu2_body      { width:100%; margin:2%;}  
    .menu2_name      { font-size: 2rem; }
    .menu2_expl      { font-size: 1.4rem; }    
    .menu2_remark    { font-size: 1.4rem; }    
    .menu2_price     { font-size: 1.9rem; }    
    .menu2_select    { font-size: 1.5rem; }
}
