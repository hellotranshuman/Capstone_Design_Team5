...
<script>
    ...
    export default {
        ...
        data(){
            return {
                translatedText: [[], ["Umecchaga", "./1/1_titleImg", "/restaurant/1/info", "/restaurant/1/menu", "/restaurant/1/review"], ["Jukuseihanamidoritokamameshi", "./2/2_titleImg", "/restaurant/2/info", "/restaurant/2/menu", "/restaurant/2/review"], ["Kushiagetokisetsunooryouri", "./3/3_titleImg", "/restaurant/3/info", "/restaurant/3/menu", "/restaurant/3/review"]],
