<template>
    ...
    <v-app>
        ...
        <v-toolbar-title style='width: 20vw'><router-link :to="{ name: 'home' }" style="text-decoration: none" class="white--text">AIOF</router-link> <router-link :to="{ name: 'home' }" style="text-decoration: none" class="red--text">Restaurant</router-link></v-toolbar-title>
        <v-text-field
        flat
        solo-inverted
        prepend-icon="search"
        ...
        >
            <v-card>
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="blue darken-1" flat>로그인</v-btn>
                    <router-link :to="{name: 'userregister'}" style="text-decoration: none;">
                        <v-btn color="blue darken-1" flat @click="login=false">회원가입</v-btn>
                    </router-link>
                </v-card-actions>
            </v-card>
        </v-dialog>
